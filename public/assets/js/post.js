            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.success) {
                        ...
                        $('[name="tittle"]').val(response.data.post_tittle);
                        $('[name="description"]').val(response.data.post_description);
                        $('[name="date"]').val(response.data.post_date);
                    }
                },
                error: function (xhr, status, error) {
                    console.log(status);
